//! Defines the memory map for the stable memory, and initializes the memory manager.
...
// We reserve the page range [0,64) for our framework.
...
// MemoryId is u8, and we reserve the ID range [224,256) for our framework.
